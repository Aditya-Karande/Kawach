let events=[];
const labels={page_visit:'Website visit',search:'Search query',file_upload:'File uploaded',file_download:'File downloaded',form_submission:'Form submitted',page_metadata:'Page metadata',chat_message:'Chat message',page_text:'Page text'};
